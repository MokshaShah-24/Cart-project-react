        ...
        return (
            <form className='row mb-5' onSubmit={(e) => {e.preventDefault();  this.props.addItem(this.state.productName,Number(this.state.productPrice));}}>
                ...
                <div className='mb-3 col-4'>
                    ...
                    <input type='number' className='form-control' id='price' name='productPrice' onChange={(e) => {this.setState({productPrice: e.currentTarget.value});}} value = {this.state.productPrice}/>
                </div>
